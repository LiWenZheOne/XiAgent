...
- variant_description 必须比 variant_name 更详细，至少 40 字，只描述图像中角色可见的外貌特征和稳定造型，按头部/发型、上身、下装、鞋履、颜色搭配、身份识别特征、稳定配件描述；不要写用途、生成目的、剧情作用；不要描述任何材质、布料质感、纹理或面料工艺。禁止输出“默认装束，无特殊造型描述”这类空泛描述。
