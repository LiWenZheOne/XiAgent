...
- Render workflow input schemas as labels, forms, pickers, toggles, image selectors, cards, status badges, and media previews. Node input/output should be presented as user-facing cards, not as raw object dumps.
